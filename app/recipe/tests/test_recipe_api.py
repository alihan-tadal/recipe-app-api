...
RECIPES_URL = reverse('recipe:recipe-list')  # Helper method
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_clear_recipe_ingredients(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Example')
        recipe = create_recipe(user=self.user)
...
class ImageUploadTests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Deneme Tarifi')
        r2 = create_recipe(user=self.user, title='Deneme Tarifi 2')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Vegetarian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Deneme Tarifi 3')

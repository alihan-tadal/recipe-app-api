...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_update_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Exqmple')
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Marul')
    ...
    def test_filtered_ingredients_unique(self):
        ...
        Ingredient.objects.create(user=self.user, name='Keten')
